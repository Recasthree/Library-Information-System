...
void register_identity() {
	...
	strcpy(newStudent->firstBook, "0000000000");
	strcpy(newStudent->secondBook, "0000000000");
	strcpy(newStudent->thirdBook, "0000000000");
	printf("|  ----------------------------------------  |\n");
	printf("|                                            |\n");
	printf("|   Please confirm whether to save or not?   |\n");
	printf("|         [1] Yes            [2] No          |\n");
			...
			while(1) {
				...
				if(x > index || x <= 0)
					...
					while(p != NULL && p->x != x)
						p = p->next;
					if(p && p->exist == 1 ) {
						if( preStudent->firstBook == "0000000000" || preStudent->secondBook == "0000000000" || preStudent->thirdBook == "0000000000" ) {
							p->exist = 2;
							strcpy(p->stu_number, preStudent->number);
							while(1) {
								if( preStudent->firstBook == "0000000000" ) {
						...
						else if( preStudent->firstBook != "0000000000" && preStudent->secondBook != "0000000000" && preStudent->thirdBook != "0000000000" ) {
		...
		do {
			...
			if(p) {
				if( p->exist == 2 ) {
					...
					else if( (preStudent->firstBook != p->number && preStudent->secondBook != p->number  && preStudent->thirdBook != p->number) || p->exist != 2 ) {
